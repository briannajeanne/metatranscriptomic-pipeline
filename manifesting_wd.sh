...
echo " " >> progress
source $script1 $working $R1 $R2 $pre
echo "source $script1 $working $R1 $R2 $pre" >> progress
source $script2 $working $R1 $R2 $pre
echo "source $script2 $working $R1 $R2 $pre" >> progress
source $script3 $working $R1 $R2 $pre
echo "source $script3 $working $R1 $R2 $pre" >> progress
source $script4 $working $R1 $R2 $pre
echo "source $script4 $working $R1 $R2 $pre" >> progress
